...
checksums_maxks_shifts_type aws_checksums_masks_shifts  = {
    ...
    {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f}, // left/right shifts
    {0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80}, //
...
cheksums_constants aws_checksums_crc64xz_constants = { //
    ...
    .x2048 = {0x8260adf2381ad81c, 0xf31fd9271e228b79,  // x^2112 mod P(x) / x^2048 mod P(x)
              0x8260adf2381ad81c, 0xf31fd9271e228b79,  // duplicated 3 times to support 64 byte avx512 loads
              0x8260adf2381ad81c, 0xf31fd9271e228b79,  //
              0x8260adf2381ad81c, 0xf31fd9271e228b79}, //
    .x1536 = {0x47b00921f036ff71, 0xb0382771eb06c453,  // x^1600 mod P(x) / x^1536 mod P(x)
              0x47b00921f036ff71, 0xb0382771eb06c453,  // duplicated 3 times to support 64 byte avx512 loads
              0x47b00921f036ff71, 0xb0382771eb06c453,  //
              0x47b00921f036ff71, 0xb0382771eb06c453}, //
    .x1024 = {0x8757d71d4fcc1000, 0xd7d86b2af73de740,  // x^1088 mod P(x) / x^1024 mod P(x)
              0x8757d71d4fcc1000, 0xd7d86b2af73de740,  // duplicated 3 times to support 64 byte avx512 loads
              0x8757d71d4fcc1000, 0xd7d86b2af73de740,  //
              0x8757d71d4fcc1000, 0xd7d86b2af73de740}, //
    .x512 = {0x6ae3efbb9dd441f3, 0x081f6054a7842df4,   // x^576 mod P(x) / x^512 mod P(x)
             0x6ae3efbb9dd441f3, 0x081f6054a7842df4,   // duplicated 3 times to support 64 byte avx512 loads
    ...
    .trailing = { // trailing input constants for data lengths of 1-15 bytes
...
#  if defined(__x86_64__)
        if (aws_cpu_has_feature(AWS_CPU_FEATURE_AVX)
