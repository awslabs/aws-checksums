...
uint32_t aws_checksums_crc32_armv8(const uint8_t *input, int length, uint64_t previous_crc32);
uint32_t aws_checksums_crc32c_armv8(const uint8_t *input, int length, uint64_t previous_crc32c);
